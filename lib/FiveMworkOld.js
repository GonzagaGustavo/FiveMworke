  ...
  generateManifest(pathsR) {
    pathsR.forEach((i) => {
      ...
      fs.writeFile(
        ...
        `fx_version 'bodacious'game 'gta5'author 'Gustavo Gonzaga'description 'Gonzaga resource'version '0.0.1'ui_page 'cms/build/index.html'file 'cms/build/*' client_script 'client/**/*.js' server_script 'server/**/*.js'`,
        (err) => {
